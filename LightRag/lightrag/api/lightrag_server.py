...
def create_app(args):
    ...
    async def login(request: Request, form_data: OAuth2PasswordRequestForm = Depends()):
        """Login endpoint - authenticates via MongoDB using email/password."""
        from lightrag.api.db_setup import (
            get_user_by_email,
            verify_password,
        ...
        from lightrag.api.routers.user_routes import get_client_ip
