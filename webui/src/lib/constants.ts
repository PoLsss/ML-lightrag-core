...
// Generate flat list of accepted file extensions
export const acceptedFileTypes = Object.values(supportedFileTypes).flat()

export const SiteInfo = {
  name: 'Master\'s UIT',
  home: '/',
  github: 'https://github.com/PoLsss/ML-lightrag-core'
}
